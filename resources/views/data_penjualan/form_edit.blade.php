...
@section('content')
   ...
   <div class="breadcrumb-header justify-content-between">
					<div>
						<h4 class="content-title mb-2">FORM EDIT PENJUALAN</h4>
							...
							<div class="card-body">
                                ...
                                <form action="{{ route('penjualan.update', $penjualan->id) }}" method="post">
									...
									<div class="row row-xs align-items-center mg-b-20">
										<div class="col-md-4">
											<label class="form-label mg-b-0">Nama penjualan</label>
										</div>
										<div class="col-md-8 mg-t-5 mg-md-t-0">
											<input class="form-control" placeholder="Enter your Nama penjualan" name="nama_penjualan" type="text">
										</div>
									</div>
									<div class="row row-xs align-items-center mg-b-20">
										<div class="col-md-4">
										...
										<div class="col-md-8 mg-t-5 mg-md-t-0">
											<input class="form-control" placeholder="Enter your harga" name="harga" type="text">
										</div>
									</div>
									<div class="row row-xs align-items-center mg-b-20">
										<div class="col-md-4">
										...
										<div class="col-md-8 mg-t-5 mg-md-t-0">
											<input class="form-control" placeholder="Enter your stok" name="stok" type="text">
										</div>
									</div>
