...
@section('content')
    <!-- breadcrumb -->
				<div class="breadcrumb-header justify-content-between">
					<div>
						<h4 class="content-title mb-2">INPUT detail penjualan</h4>
						...
						<div class="card">
							<div class="card-body">
								<div class="main-content-label mg-b-5">
									Form Input Data detail penjualan
								</div>
                                ...
                                <form action="{{ route('detail penjualan.store') }}" method="post">
									...
									<div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-3">
                                            <label class="form-label mg-b-0">Nama detail penjualan </label>
                                        </div>
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
											<input class="form-control" placeholder="Enter your Nama detail penjualan" name="nama_detail penjualan" type="text">
										</div>
									</div>
									<div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-3">
									...
									<a href="{{ route('detail penjualan.index') }}" class="btn btn-dark pd-x-30 mg-t-5"> << BACK </a>
                                </form>
								</div>
							</div>
						</div>
